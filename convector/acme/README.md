...
npm run cc:start -- motocicleta
# Make a testing call to create a record in the ledger
# Beware that the first call may fail with a timeout! Just happens the first time
hurl invoke motocicleta motocicleta_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
npm run cc:package -- motocicleta org1
# Install to your blockchain - From the root of your project
hurl install motocicleta node -P ./chaincode-motocicleta
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install motocicleta node -P ./chaincode-motocicleta --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade motocicleta node 1.2 -P ./chaincode-motocicleta
```
...
# Upgrade your existing chaincode - From the root of your project
npm run cc:upgrade -- motocicleta 1.2
```
